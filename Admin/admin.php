...
include('Templates/ver.php');
include('Templates/update_latest.php');
$up_avl = $latest - $ver;
?>
...
<div id="lmidall">
    <div id="lmidlc">
        <div id="lleft" style="width: 160px;">
            <a href="<?php echo HOMEPAGE; ?>"><img src="../img/en/a/travian0.gif" class="logo_plus" width="116"
                ...
                if ($funct->CheckLogin()) {
                    if ($_POST or $_GET) {
                        ...
                        if ($_POST['p'] and $_POST['s']) {
                            $filename = 'Templates/results_' . $_POST['p'] . '.php';
                            if (file_exists($filename)) {
                                include($filename);
                            } else {
                                include('Templates/404.php');
