<form action="../GameEngine/Admin/Mods/medals.php" method="POST">
    ...
    <table id="profile">
        ...
        if (sizeof($varmedal) == 0) { ?>
            <td colspan="5">
                <center>This player has no medals yet</center>
            </td><?php
        ...
        <td>
            <form action="../GameEngine/Admin/Mods/deletemedalbyuser.php" method="POST">
                <input type="hidden" name="admid" id="admid" value="<?php echo $_SESSION['id']; ?>">
                <input type="image" name="userid" value="<?php echo $id; ?>"
                       style="background-image: url('../gpack/travian_default/img/a/del.gif'); height: 12px; width: 12px;"
                       src="../gpack/travian_default/img/a/x.gif">
            </form>
        </td>
        </tbody>
    </table>
