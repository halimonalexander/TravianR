<form action="../GameEngine/Admin/Mods/mainteneceBan.php" method="POST">
    ...
    <table id="member" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td class="hab"><input type="text" class="fm" name="start"
                                   value="<?php echo date('d-m-Y H:i:s', strtotime("now")); ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="hab" colspan="2">
                <center><input type="text" class="fm" name="reason" value="Server Downtime"></center>
            </td>
        </tr>
        <tr>
            <td class="hab" colspan="2">
