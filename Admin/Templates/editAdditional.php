...
if (isset($id)) {
    ...
    <form action="../GameEngine/Admin/Mods/additional.php" method="POST">
        ...
        <table id="profile" cellpadding="0" cellspacing="0">
            <thead>
            <tr>
                <th colspan="2">Edit Additional Info For: <a
                            href="admin.php?p=player&uid=<?php echo $user['id']; ?>"><?php echo $user['username']; ?></a>
                </th>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td>
                    <select name="access" class="dropdown">
                        <option value="0" <?php if ($user['access'] == 0) {
                            echo 'selected="selected"';
                        } else {
                            echo '';
                        } ?>>Banned
                        </option>
                        <option value="2" <?php if ($user['access'] == 2) {
                            echo 'selected="selected"';
                        } else {
                            echo '';
                        } ?>>Normal User
                        </option>
                        <option value="8" <?php if ($user['access'] == 8) {
                            echo 'selected="selected"';
                        } else {
                            echo '';
                        } ?>>Multihunter
                        </option>
                        <option value="9" <?php if ($user['access'] == 9) {
                            echo 'selected="selected"';
                        } else {
                            echo '';
                        } ?>>Admin
            ...
            <tr>
                <td>Edit Gold</td>
                <td>
                    <input class="give_gold" name="gold" value="<?php echo $user['gold']; ?>"> <img
                            src="../img/admin/gold.gif">
                </td>
            </tr>
            <tr>
                <td>Sitter 1</td>
            ...
            <thead>
            <tr>
                <td style="border-right:none; text-align:left"><input name="back" type="image" id="btn_back"
                                                                      class="dynamic_img" src="img/x.gif" value="back"
                                                                      alt="back"
                                                                      onclick="return go_url('../Admin/admin.php?p=player&uid=<?php echo $_GET["uid"]; ?>')"/>
                </td>
                <td style="border-left:none; text-align:right" colspan="5"><input name="save" type="image" id="btn_save"
