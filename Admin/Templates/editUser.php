        ...
        <tr>
            <td class="details">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <select name="tribe" class="dropdown">
                                ...
                                <option value="4" <?php if ($user['tribe'] == 4) {
                                    echo "selected='selected'";
                                } else {
                                } ?>>Nature
                                </option>
                                <option value="5" <?php if ($user['tribe'] == 5) {
                                    echo "selected='selected'";
                                } else {
                                } ?>>Natars
                                </option>
                    ...
                    <tr>
                        <th>E-mail</th>
                        <td><input class="fm" name="email" value="<?php echo $user['email']; ?>"></td>
                    </tr>
                    <tr>
                    <tr>
                        <th>Quest</th>
                        <td><input class="fm" name="quest" value="<?php echo $user['quest']; ?>"></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="empty"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="?p=player&uid=<?php echo $user['id']; ?>"><span
                                        class="rn2">&raquo;</span> Go back</a></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="empty"></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="desc2"><textarea cols="25" rows="14" tabindex="1"
                                                                name="desc1"><?php echo nl2br($user['desc1']); ?></textarea>
                        </td>
                    </tr>
                </table>
            </td>
