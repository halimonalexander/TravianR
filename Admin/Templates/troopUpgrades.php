...
<table id="member">
    ...
    <tr>
        ...
        for ($i = 1; $i < 9; $i++) {
            if ($tribe == 5) {
                $abtech['a' . $i] = "<font color=\"grey\">?</font>";
                $abtech['b' . $i] = "<font color=\"grey\">?</font>";
            }
...
if ($_SESSION['access'] == ADMIN) {
    if ($tribe == 5) {
        echo '<span class="none">Upgrades Troops</span>';
    } else {
        echo '<a href="admin.php?p=addABTroops&did=' . $_GET['did'] . '">Upgrades Troops</a>';
    }
}
if (isset($_GET['ab'])) {
