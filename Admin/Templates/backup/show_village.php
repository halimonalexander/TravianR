...
<div id="content" class="player" style="width:100%">
    <table id="profile" cellpadding="1" cellspacing="1">
        <thead>
        <tr>
            <th colspan="2">Village: <a href="?wref=<?php echo $village['wref']; ?>"><?php echo $village['name']; ?></a>
                - user '<?php echo $village['owner']; ?>'
            </th>
        </tr>
        <tr>
            <td>Details</td>
        ...
        <tr>
            <td class="details">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2"><a href="?edit=user&uid=<?php echo $_GET['uid']; ?>">&raquo; Change profile</a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="?action=message&amp;id=<?php echo $_GET['uid']; ?>">&raquo; Write
                                message</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><a
                                    href="#?uid=<?php echo $_GET['uid']; ?>&delete=<?php echo $_GET['uid']; ?>&where=user">&raquo;
                                Delete player</a></td>
                    </tr>
                </table>
    ...
    <table id="villages" cellpadding="1" cellspacing="1">
        ...
        foreach ($villages as $vil) {
            ...
            if ($vil['capital'] == 1) {
                $cap = '<span class="none3">(capital)</span>';
            } else {
                $cap = "";
            }
            echo '
