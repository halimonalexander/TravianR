                ...
                <form method="post" name="snd" action="login.php">
                    ...
                    <table cellpadding="1" cellspacing="1" id="login_form">
                        ...
                        <tr class="top">
                            ...
                            <td><input class="text" type="text" name="user"
                                       ...
                                       maxlength="30" autocomplete='off'/> <span
                                        class="error"> <?php echo $form->getError("user"); ?></span></td>
                        </tr>
                        <tr class="btm">
                            <th><?php echo PASSWORD; ?></th>
                            <td><input class="text" type="password" name="pw"
                                       value="<?php echo $form->getValue("pw"); ?>" maxlength="100" autocomplete='off'/>
                                <span class="error"><?php echo $form->getError("pw"); ?></span></td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <p class="btn">
                        ...
                        <input type="image" value="login" name="s1" onclick="xy();" id="btn_login" class="dynamic_img"
                               src="img/x.gif" alt="login button"/>
                    </p>
