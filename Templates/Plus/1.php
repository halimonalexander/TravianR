...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <td class="desc">
            Basically, we reserve the ordered amount of gold immediately after the payment. If there are any problems,
            please send an email to our
            <a href="mailto:cata7007@gmail.com">payment account</a>. <br/><br/><b>Username<br/>Payment Method<br/>Ordered
                Package<br/>
...
<div id="products">
    ...
    <div class="clear"></div>
    <div style="padding: 10px 10px; font-style: italic; font-size: 10px; color: #F00;"><b>None of the packages are
            refundable!</b></div>
