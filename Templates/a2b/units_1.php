...
<form method="POST" name="snd" action="a2b.php"><input name="timestamp" value="1278280730" type="hidden"> <input
    ...
    <table id="troops" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td class="line-first column-first large"><img class="unit u1" src="img/x.gif" title="Legionnaire"
                        ...
                        class="text" <?php if ($village->unitarray['u1'] <= 0) {
            ...
            <td class="line-first large"><img class="unit u4" src="img/x.gif" title="Equites Legati"
                                              alt="Equites Legati"> <input
                        class="text" <?php if ($village->unitarray['u4'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first regular"><img class="unit u7" src="img/x.gif" title="Battering Ram"
                        ...
                        class="text" <?php if ($village->unitarray['u7'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first column-last small"><img class="unit u9" src="img/x.gif" title="Senator" alt="Senator">
                <input class="text" <?php if ($village->unitarray['u9'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="column-first large"><img class="unit u2" src="img/x.gif" title="Praetorian" alt="Praetorian">
                <input class="text" <?php if ($village->unitarray['u2'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="large"><img class="unit u5" src="img/x.gif" title="Equites Imperatoris"
                                   alt="Equites Imperatoris"> <input
                        class="text" <?php if ($village->unitarray['u5'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="regular"><img class="unit u8" src="img/x.gif" title="Fire Catapult" alt="Fire Catapult"> <input
                        class="text" <?php if ($village->unitarray['u8'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="line-last column-first large"><img class="unit u3" src="img/x.gif" title="Imperian"
                                                          alt="Imperian"> <input
                        class="text" <?php if ($village->unitarray['u3'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-last large"><img class="unit u6" src="img/x.gif" title="Equites Caesaris"
                        ...
                        class="text" <?php if ($village->unitarray['u6'] <= 0) {
                    echo ' disabled="disabled"';
