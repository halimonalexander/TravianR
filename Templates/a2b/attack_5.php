    ...
    <table class="troop_details" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td><img src="img/x.gif" class="unit u43" title="Guardsman" alt="Guardsman></td>
                        ...
                        <td><img src=" img/x.gif" class="unit u44" title="Bird of Prey" alt="Bird of Prey">
            </td>
        ...
        <?php if ($process['c'] == 1) {
            ...
            <tr>
                ...
                <td colspan="<?php if ($process['t11'] != '') {
                    ...
                    echo "10";
                } ?>"><input class="radio" name="spy" value="1" checked="checked" type="radio">Scout resources and
                    troops<br>
        ...
        <tr>
            ...
            <tr>
                ...
                <td colspan="<?php if ($process['t11'] != '') {
                    ...
                    <div class="at">at <span
                                id="tp2"> <?php echo $generator->procMtime(date('U') + $time, 9) ?></span><span> hours</span>
                    </div>
