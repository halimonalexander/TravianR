    ...
    <table id="troops" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td class="line-first column-first large"><img class="unit u11" src="img/x.gif" title="Clubswinger"
                        ...
                        class="text" <?php if ($village->unitarray['u11'] <= 0) {
            ...
            <td class="line-first large"><img class="unit u14" src="img/x.gif" title="Scout" alt="Scout"> <input
                        class="text" <?php if ($village->unitarray['u14'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first regular"><img class="unit u17" src="img/x.gif" title="Ram" alt="Ram"> <input
                        class="text" <?php if ($village->unitarray['u17'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first column-last small"><img class="unit u19" src="img/x.gif" title="Chief" alt="Chief">
                <input class="text" <?php if ($village->unitarray['u19'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="column-first large"><img class="unit u12" src="img/x.gif" title="Spearman" alt="Spearman"> <input
                        class="text" <?php if ($village->unitarray['u12'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="large"><img class="unit u15" src="img/x.gif" title="Paladin" alt="Paladin"> <input
                        class="text" <?php if ($village->unitarray['u15'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="regular"><img class="unit u18" src="img/x.gif" title="Catapult" alt="Catapult"> <input
                        class="text" <?php if ($village->unitarray['u18'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="column-last small"><img class="unit u20" src="img/x.gif" title="Settler" alt="Settler"> <input
                        class="text" <?php if ($village->unitarray['u20'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="line-last column-first large"><img class="unit u13" src="img/x.gif" title="Axeman" alt="Axeman">
                <input class="text" <?php if ($village->unitarray['u13'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-last large"><img class="unit u16" src="img/x.gif" title="Teutonic Knight"
                        ...
                        class="text" <?php if ($village->unitarray['u16'] <= 0) {
                    echo ' disabled="disabled"';
