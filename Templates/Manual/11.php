<h1><img class="unit u1" src="img/x.gif" alt="Legionnaire" title="Legionnaire"/> Legionnaire <span class="tribe">(Romans)</span>
</h1>
...
<img id="big_unit" class="big_u1" src="img/x.gif" alt="Legionnaire" title="Legionnaire"/>
