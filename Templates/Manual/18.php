<h1><img class="unit u8" src="img/x.gif" alt="Fire Catapult" title="Fire Catapult"/> Fire Catapult <span class="tribe">(Romans)</span>
</h1>
...
<img id="big_unit" class="big_u8" src="img/x.gif" alt="Fire Catapult" title="Fire Catapult"/>
