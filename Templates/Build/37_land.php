...
<table id="oases" cellpadding="1" cellspacing="1">
    ...
    for ($i = 0; $i < count($oasisarray); $i++) {
        ...
        <tr>
            <td class="nam">
                <a href="build.php?gid=37&c=<?php echo $generator->getMapCheck($oasisarray[$i]['wref']); ?>&del=<?php echo $oasisarray[$i]['wref']; ?>&land"><img
                            class="del" src="img/x.gif" alt="delete" title="<?php echo DELETE; ?>"></a>
