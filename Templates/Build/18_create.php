        ...
        <table cellpadding="1" cellspacing="1" id="found">
            <form method="post" action="build.php">
                ...
                <tr>
                    <th><?php echo TAG; ?></th>
                    <td class="tag">
                        <input class="text" name="ally1" disabled="disabled"
                               value="<?php echo $form->getValue("ally1"); ?>" maxlength="8">
                        <span class="error"><?php echo $form->getError("ally1"); ?></span>
                ...
                <tr>
                    <th><?php echo NAME; ?></th>
                    <td class="nam">
                        <input class="text" name="ally2" disabled="disabled"
                               value="<?php echo $form->getValue("ally2"); ?>" maxlength="25">
                        <span class="error"><?php echo $form->getError("ally2"); ?></span>
                    </td>
