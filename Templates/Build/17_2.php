<div id="build" class="gid17"><a href="#" onClick="return Popup(17,4);" class="build_logo">
    ...
    <h1>
        <span class="level"><?php echo MARKETPLACE; ?><?php echo LEVEL; ?><?php echo $village->resarray['f' . $id]; ?></span>
    </h1>
    ...
    <form method="POST" action="build.php">
        ...
        <table id="sell" cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td class="tra"><input class="check" type="checkbox" tabindex="5" name="d1"
                                       value="1"/> <?php echo MAX_TIME_TRANSPORT; ?>: <input class="text" tabindex="6"
                                                                                             name="d2" value="2"
                                                                                             maxlength="2"/> <?php echo HOURS; ?>
                </td>
            </tr>
            <tr>
        ...
        ?>
        <input type="image" tabindex="8" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="img/x.gif"
               alt="OK" <?php //if(!$market->merchantAvail()) { echo "DISABLED"; }?>/></p>
    </form>
    <?php
