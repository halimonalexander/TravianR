<?php
if (!$session->goldclub) {
    include "Templates/Build/16.php";
} else {
    ?>
    <div id="build" class="gid16"><a href="#" onClick="return Popup(16,4);" class="build_logo">
        ...
        <div id="raidList">
            <?php include "Templates/goldClub/farmlist.php"; ?>
        </div>
        <br/>
        <?php if ($hideevasion == 0) { ?>
            <table cellpadding="1" cellspacing="1">
                ...
                for ($i = 0; $i <= count($session->villages) - 1; $i++) {
                    ...
                    ?>
                    <tr>
                        <td><input type="checkbox" class="check" name="hideShow"
                                   onclick="window.location.href = '?gid=16&t=99&evasion=<?php echo $wref; ?>';" <?php echo $checked; ?>>
                        </td>
            ...
            <form action="build.php?id=39&t=99" method="POST">
                <br/>
                <tr>
                    <?php echo SEND_TROOPS_AWAY_MAX; ?> <input class="text" type="text" name="maxevasion"
                                                               value="<?php echo $user['maxevasion']; ?>" maxlength="3"
                                                               style="width:50px;"> <?php echo TIMES; ?>
                    <span class="none">(<?php echo COSTS; ?>: <img src="<?php echo GP_LOCATE; ?>img/a/gold_g.gif"
                                                                   alt="Gold"
                                                                   title="<?php echo GOLD; ?>"/><b>2</b> <?php echo PER_EVASION; ?>)</span>

                </tr>
                <tr>
                    <div class="clear"></div>
                    <p><input type="image" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="img/x.gif"
                              tabindex="8" alt="OK"/></p>
            </form>
            </tr>
            </form>
