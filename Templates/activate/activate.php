<div id="content" class="signup">
    ...
    <div id="no_mail">
        <p>
            <a href="activate.php?id=<?php echo $_GET['id']; ?>&amp;c=<?php echo $generator->encodeStr($email, 5); ?>"><span
                        class="important">No email received?</span></a>
        </p>
        <p>
            Sometimes the email is moved to the spam folder. For further help click <a
                    href="activate.php?id=<?php echo $_GET['id']; ?>&amp;c=<?php echo $generator->encodeStr($email, 5); ?>">here</a>
        </p>
    </div>
</div>
<?php if (START_DATE > date('m/d/Y') or START_DATE == date('m/d/Y') && START_TIME <= date('H:i')) { ?>
    <br/>
    <center><big>Activation Availble in: </big></center>
