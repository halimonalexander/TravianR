...
<map name="map2" id="map2">
    ...
    <area href="build.php?id=40" title="<?php echo $wtitle; ?>" coords="49,338,0,274,0,240,33,286,88,338" shape="poly"
          alt=""/>
    <area href="build.php?id=40" title="<?php echo $wtitle; ?>"
...
<div id="village_map" class="<?php echo $vmapc; ?>">
    ...
    ?>
    <div id="levels" <?php if (isset($_COOKIE['t3l'])) {
        echo "class=\"on\"";
    } ?> >
        <?php
        for ($i = 1; $i <= 20; $i++) {
...
<img src="img/x.gif" id="lswitch" <?php if (isset($_COOKIE['t3l'])) {
    echo "class=\"on\"";
