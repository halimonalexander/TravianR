...
if ($session->access != BANNED) {
    ...
    ?>
    <h4><a href="allianz.php?s=2&pid=<?php echo $arr['alliance']; ?>">Alliance</a> -> <a
    ...
    <table cellpadding="1" cellspacing="1" id="posts">
        ...
        <tr>
            ...
            <td class="pcontent">
                <div class="posted">created: <?php echo $date; ?></div>
                <?php
        ...
        <?php if ($database->checkSurvey($arr['id'])) {
            ...
            if (!$database->checkVote($arr['id'], $session->uid) && ($survey['ends'] > time() || $survey['ends'] == 0)) {
                ...
                <tr>
                    <td colspan="2">
                        <div>
                            <center>Survey: <?php echo $survey['title']; ?></center>
                        </div>
                        <div class="clear dotted"></div>
                        <form method="post" name="post"
                            ...
                            <div class="text">
                                ...
                                <p class="btn"><input type="image" id="fbtn_vote" value="ok" name="s1"
