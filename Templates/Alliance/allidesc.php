...
<table cellpadding="1" cellspacing="1" id="edit">
    ...
    <tr>
        ...
        <td class="s7">
        <?php echo $allianceinfo['tag']; ?></th>
        <td rowspan="8" class="desc1"><textarea tabindex="1"
                                                name="be1"><?php echo stripslashes($allianceinfo['desc']); ?></textarea>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2" class="desc2"><textarea tabindex="2"
                                                name="be2"><?php echo stripslashes($allianceinfo['notice']); ?></textarea>
        </td>
    </tr>
    <p>
...
<p class="btn"><input tabindex="3" type="image" value="" name="s1" id="btn_save" class="dynamic_img" src="img/x.gif"
                      alt="save"/></p></form>