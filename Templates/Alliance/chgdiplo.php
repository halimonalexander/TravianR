...
<form method="post" action="allianz.php">
    ...
    <table cellpadding="1" cellspacing="1" id="diplomacy" class="dipl">
        ...
        <tr>
            <td colspan="2"><label><input class="radio" type="radio" name="dipl" value="1"> offer a
                    confederation</label></td>
        </tr>

        <tr>
            <td colspan="2"><label><input class="radio" type="radio" name="dipl" value="2"> offer non-aggression
                    pact</label></td>
        </tr>
    ...
    <table cellpadding="1" cellspacing="1" id="hint" class="infos">
        ...
        <tbody>
        <tr>
            <td colspan="2">It's part of diplomatic etiquette to talk to another alliance and negotiate before sending
                an offer for a non-aggression pact or a confederation.
            </td>
        </tr>
        </tbody>
    </table>
...
<table cellpadding="1" cellspacing="1" id="tip" class="infos">
    ...
    <tbody>
    <tr>
        <td colspan="2">If you want to see connections in the alliance description automatically, type <span class="e">[diplomatie]</span>
            into the description, <span class="e">[ally]</span>, <span class="e">[nap]</span> and <span
                    class="e">[war]</span> are also possible.
        </td>
    </tr>
    </tbody>
</table>
