    ...
    <div class="wrapper">
        ...
        <div id="mid">
			...
			***************************";
                    ...
                    $q = "INSERT INTO users (id,username,password,access,email,timestamp,tribe,location,act,protect) VALUES (3, '$username', '$password', " . USER . ", '$email', " . time() . ", $tribe, '', '', 0)";
                    mysql_query($q);
                    unset($q);
                    ...
                    $wid = mysql_fetch_assoc(mysql_query("SELECT * FROM vdata WHERE owner = $uid"));
                    $q = "UPDATE vdata SET pop = 834 WHERE owner = $uid";
                    mysql_query($q));
                    $q2 = "UPDATE users SET access = 2 WHERE id = $uid";
                    mysql_query($q2));
                    if (SPEED > 3) {
                        $speed = 5;
                    } else {
                    ...
                    $q3 = "UPDATE units SET u41 = " . (64700 * $speed) . ", u42 = " . (295231 * $speed) . ", u43 = " . (180747 * $speed) . ", u44 = " . (20000 * $speed) . ", u45 = " . (364401 * $speed) . ", u46 = " . (217602 * $speed) . ", u47 = " . (2034 * $speed) . ", u48 = " . (1040 * $speed) . " , u49 = " . (1 * $speed) . ", u50 = " . (9 * $speed) . " WHERE vref = " . $wid['wref'] . "";
                    mysql_query($q3));
                    $q4 = "UPDATE users SET desc2 = '$desc' WHERE id = $uid";
                    mysql_query($q4));
                    ...
                    $natar = mysql_fetch_array(mysql_query("SELECT * FROM vdata WHERE owner = $uid and capital = 1"));
                    $multiplier = NATARS_UNITS;
                    $q = "SELECT * FROM vdata WHERE capital = '1' and owner > '5'";
                    ...
                    function Artefact($uid, $type, $size, $art_name, $village_name, $desc, $effect, $img)
                    {
                        ...
                        $database->addTech($wid);
                        $database->addABTech($wid);
                        mysql_query("UPDATE vdata SET pop = 163 WHERE wref = $wid");
                        mysql_query("UPDATE vdata SET name = '$village_name' WHERE wref = $wid");
                        if (SPEED > 3) {
                            $speed = 5;
                        } else {
                            $speed = SPEED;
                        ...
                        if ($size == 1) {
                            mysql_query("UPDATE units SET u41 = " . (rand(1000, 2000) * $speed) . ", u42 = " . (rand(1500, 2000) * $speed) . ", u43 = " . (rand(2300, 2800) * $speed) . ", u44 = " . (rand(25, 75) * $speed) . ", u45 = " . (rand(1200, 1900) * $speed) . ", u46 = " . (rand(1500, 2000) * $speed) . ", u47 = " . (rand(500, 900) * $speed) . ", u48 = " . (rand(100, 300) * $speed) . " , u49 = " . (rand(1, 5) * $speed) . ", u50 = " . (rand(1, 5) * $speed) . " WHERE vref = " . $wid . "");
                            mysql_query("UPDATE fdata SET f22t = 27, f22 = 10, f28t = 25, f28 = 10, f19t = 23, f19 = 10, f32t = 23, f32 = 10 WHERE vref = $wid");
                        } elseif ($size == 2) {
                            mysql_query("UPDATE units SET u41 = " . (rand(2000, 4000) * $speed) . ", u42 = " . (rand(3000, 4000) * $speed) . ", u43 = " . (rand(4600, 5600) * $speed) . ", u44 = " . (rand(50, 150) * $speed) . ", u45 = " . (rand(2400, 3800) * $speed) . ", u46 = " . (rand(3000, 4000) * $speed) . ", u47 = " . (rand(1000, 1800) * $speed) . ", u48 = " . (rand(200, 600) * $speed) . " , u49 = " . (rand(2, 10) * $speed) . ", u50 = " . (rand(2, 10) * $speed) . " WHERE vref = " . $wid . "");
                            mysql_query("UPDATE fdata SET f22t = 27, f22 = 10, f28t = 25, f28 = 20, f19t = 23, f19 = 10, f32t = 23, f32 = 10 WHERE vref = $wid");
                        } elseif ($size == 3) {
                            mysql_query("UPDATE units SET u41 = " . (rand(4000, 8000) * $speed) . ", u42 = " . (rand(6000, 8000) * $speed) . ", u43 = " . (rand(9200, 11200) * $speed) . ", u44 = " . (rand(100, 300) * $speed) . ", u45 = " . (rand(4800, 7600) * $speed) . ", u46 = " . (rand(6000, 8000) * $speed) . ", u47 = " . (rand(2000, 3600) * $speed) . ", u48 = " . (rand(400, 1200) * $speed) . " , u49 = " . (rand(4, 20) * $speed) . ", u50 = " . (rand(4, 20) * $speed) . " WHERE vref = " . $wid . "");
                            mysql_query("UPDATE fdata SET f22t = 27, f22 = 10, f28t = 25, f28 = 20, f19t = 23, f19 = 10, f32t = 23, f32 = 10 WHERE vref = $wid");
                        }
                    }
