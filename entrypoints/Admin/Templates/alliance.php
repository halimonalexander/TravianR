...
if ($_GET['aid']) {
    ...
    if ($alidata and $aliusers) {
        ...
        <table id="profile" cellpadding="1" cellspacing="1">
            <thead>
            <tr>
                <th colspan="2">Alliance <a
                            href="?p=alliance&aid=<?php echo $alidata['id']; ?>"><?php echo $alidata['name']; ?></a>
                </th>
            </tr>
            <tr>
                <td>Details</td>
                ...
                <td class="details">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?p=player&uid=<?php echo $alidata['leader']; ?>"><?php echo $database->getUserField($alidata['leader'], "username", 0); ?></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            if ($row['opt1'] == 1) {
                                $position1 = "Assign To Position";
                            } else {
                                $position1 = "No Assigning Positions";
                            }
                            if ($row['opt2'] == 1) {
                                $position2 = "Kick Players";
                            } else {
                                $position2 = "No Kicking Players";
                            }
                            if ($row['opt3'] == 1) {
                                $position3 = "Change Alliance Description";
                            } else {
                                $position3 = "No Changing Description";
                            }
                            if ($row['opt4'] == 1) {
                                $position4 = "Invite Players";
                            } else {
                                $position4 = "No Invitations";
                            }
                            if ($row['opt5'] == 1) {
                                $position5 = "Manage Forums";
                            } else {
                                $position5 = "No Forum Management";
                            }
                            if ($row['opt6'] == 1) {
                                $position6 = "Alliance Diplomacy";
                            } else {
                                $position6 = "No Diplomacy";
                            }
                            if ($row['opt7'] == 1) {
                                $position7 = "Mass IGMs (MMs)";
                            } else {
                                $position7 = "No MMs";
                            }
                            if ($row['opt8'] == 1) {
                        ...
                        <tr>
                            <td colspan="2"><a href="?p=editAli&aid=<?php echo $alidata['id']; ?>">» Edit Alliance</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="?p=DelAli&aid=<?php echo $alidata['id']; ?>">» Delete Alliance</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="empty"></td>
        ...
        <table id="profile">
            ...
            while ($row = mysql_fetch_assoc($result)) {
                if ($row['type'] == 1) {
                    $type = 'Confederation Pact';
                }
                if ($row['type'] == 2) {
                    $type = 'Non Agression Pact';
                }
                if ($row['type'] == 3) {
                    $type = 'Declaration of War';
                }
                if ($row['accepted'] == 0) {
                    $accepted = "<img src=\"../../gpack/travian_default/img/a/del.gif\">";
                }
                if ($row['accepted'] == 1) {
                    $accepted = "<img src=\"../../gpack/travian_default/img/a/acc.gif\">";
                }
            ...
            while ($row = mysql_fetch_assoc($result)) {
                ...
                echo '
						<tr>
							...
							<td>' . $type . '</td>
							<td><img src="../../../resources/gpack/travian_default/img/a/acc.gif"></td>
						</tr>';
            }
            ?>
            </thead>
