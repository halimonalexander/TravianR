...
//if(isset($_GET['c']))
//{
//	copy("https://raw.github.com/yi12345/TravianZ/master/Admin/Templates/update_latest.tpl", "Templates/update_latest.php");
//}
include('update_latest.php');
/*
if(isset($_GET['u']))
{
...
<table id="member" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <td class="hab" colspan="1"><font color="red"><?php include('ver.php');
                echo "$ver"; ?></font></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="hab" colspan="1">
            <center><a href="?p=update&c"><img src="../img/admin/b/ok1.gif"></a></center>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="hab" colspan="1">
            <center><a href="#"><img src="../img/admin/b/ok1.gif"></a></center>
        </td>
    </tr>
    </tbody>
</table>