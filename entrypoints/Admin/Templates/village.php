...
if (isset($id)) {
    ...
    if (count($result) > 0) {
        foreach ($result as $row) {
            $type = $row['type'];
            if ($type == 1) {
                $type = '<img src="../img/admin/r/1.gif"> + 25%';
                $wood += 1;
            } elseif ($type == 2) {
                $type = '<img src="../img/admin/r/1.gif"> + 25%';
                $wood += 1;
            } elseif ($type == 3) {
                $type = '<img src="../img/admin/r/1.gif"> + 25%<br /><img src="../img/admin/r/4.gif"> + 25%';
                $wood += 1;
                $crop += 1;
            } elseif ($type == 4) {
                $type = '<img src="../img/admin/r/2.gif"> + 25%';
                $clay += 1;
            } elseif ($type == 5) {
                $type = '<img src="../img/admin/r/2.gif"> + 25%';
                $clay += 1;
            } elseif ($type == 6) {
                $type = '<img src="../img/admin/r/2.gif"> + 25%<br /><img src="../img/admin/r/4.gif"> + 25%';
                $clay += 1;
                $crop += 1;
            } elseif ($type == 7) {
                $type = '<img src="../img/admin/r/3.gif"> + 25%';
                $iron += 1;
            } elseif ($type == 8) {
                $type = '<img src="../img/admin/r/3.gif"> + 25%';
                $iron += 1;
            } elseif ($type == 9) {
                $type = '<img src="../img/admin/r/3.gif"> + 25%<br /><img src="../img/admin/r/4.gif"> + 25%';
                $iron += 1;
                $crop += 1;
            } elseif ($type == 10) {
                $type = '<img src="../img/admin/r/4.gif"> + 25%';
                $crop += 1;
            } elseif ($type == 11) {
                $type = '<img src="../img/admin/r/4.gif"> + 25%';
                $crop += 1;
            } elseif ($type == 12) {
                $type = '<img src="../img/admin/r/4.gif"> + 50%';
                $crop += 2;
            }
        }
    }
    ...
    ;
    $generator = new Travian\MyGenerator;
    ...
    if ($village and $user) {
        ...
        <table id="profile" cellpadding="1" cellspacing="1">
            ...
            <tr>
                <td>Village owner:</td>
                <td>
                    <a href="admin.php?p=player&uid=<?php echo $village['owner']; ?>"><?php echo $user['username']; ?></a>
                </td>
                <td>
                    <form action="../GameEngine/Admin/Mods/editVillageOwner.php" method="POST" accept-charset="UTF-8">
                        ...
                        Owner(uid): <input class="text" type="text" name="newowner"
                                           value="<?php echo $user['id']; ?>"><input type="image" value="submit"
            ...
            <tr>
                ...
                <form action="../GameEngine/Admin/Mods/renameVillage.php" method="POST" accept-charset="UTF-8">
                    ...
                    <input type="hidden" name="admid" id="admid" value="<?php echo $_SESSION['id']; ?>">
                    <td colspan="2">
                        <input class="text" type="text" name="villagename" value="<?php echo $village['name']; ?>">
                        <input type="image" value="submit" src="../img/admin/edit.gif">
                    </td>
                </form>
            </tr>
            <tr>
                <td>Population</td>
                <td colspan="2"><?php echo $village['pop']; ?> <a
                            href="admin.php?action=recountPop&did=<?php echo $_GET['did']; ?>"><?php echo $refreshicon; ?></a>
                </td>
            </tr>
            <tr>
                <td>Coordinates:</td>
                <td colspan="2"><a
                            href="<?php echo HOMEPAGE ?>/karte.php?d=<?php echo $village['wref']; ?>&c=<?php echo $generator->getMapCheck($village['wref']); ?>"
                            target="blank">(<?php echo $coor['x'] . "|" . $coor['y']; ?>)</a></td>
            </tr>
            <tr>
                <td>Village ID</td>
        ...
        <table id="member">
            <thead>
            <tr>
                <th colspan="7">Resources <a href="admin.php?p=editResources&did=<?php echo $_GET['did']; ?>"><img
                                src="../img/admin/edit.gif" title="Edit Resources and Capacity"></a></th>
            </tr>
            <tr>
                <td>Resource</td>
            ...
            <tr>
                ...
                <td>
                    <center><?php echo floor($village['wood']); ?></center>
                </td>
                <td rowspan="3">
                    <center><?php echo $village['maxstore']; ?></center>
                </td>
                <td>
                    <center><?php echo $production['wood']; ?></td>
            </tr>
            </tr>
            <tr>
                <td><img class="r2" src="../img/x.gif"> Clay</td>
                <td>
                    <center><?php echo floor($village['clay']); ?></center>
                </td>
                <td>
                    <center><?php echo $production['clay']; ?></center>
                </td>
            </tr>
            <tr>
                <td><img class="r3" src="../img/x.gif"> Iron</td>
                <td>
                    <center><?php echo floor($village['iron']); ?></center>
                </td>
                <td>
                    <center><?php echo $production['iron']; ?></center>
                </td>
            </tr>
            <tr>
                <td><img class="r4" src="../img/x.gif"> Crop</td>
                <td>
                    <center><?php echo floor($village['crop']); ?></center>
                </td>
                <td>
                    <center><?php echo $village['maxcrop']; ?></center>
                </td>
                <td>
                    <center><?php echo $production['crop']; ?></center>
                </td>
            </tr>
            </tbody>
        </table>
