...
<table id="member">
    <thead>
    <tr>
        <th>Server Settings <a href="admin.php?p=editServerSet"><img src="../img/admin/edit.gif"
                                                                     title="Edit Setting"></a></th>
    </tr>
    </thead>
</table>
...
<table id="profile">
    ...
    <tr>
        <td>Register Open</td>
        <td><?php if (REG_OPEN == true) {
                echo "<b><font color='blue'>True</font></b>";
            } else {
                echo "<b><font color='Red'>False</font></b>";
            } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Quest Type</td>
        <td><?php if (QTYPE == 25) {
                echo "<b><font color='Blue'>Travian Official</font></b>";
            } else {
                echo "<b><font color='Blue'>TravianZ Extended</font></b>";
            } ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php if (NATURE_REGTIME >= 86400) {
                echo '' . (NATURE_REGTIME / 86400) . ' Days';
            } else if (NATURE_REGTIME < 86400) {
                echo '' . (NATURE_REGTIME / 3600) . ' Hours';
            } ?></td>
    </tr>
    <tr>
        <td>Medal Interval</td>
        <td><?php if (MEDALINTERVAL >= 86400) {
                echo '' . (MEDALINTERVAL / 86400) . ' Days';
            } else if (MEDALINTERVAL < 86400) {
...
<table id="member">
    <thead>
    <tr>
        <th>Log Settings <a href="admin.php?p=editLogSet"><img src="../img/admin/edit.gif" title="Edit Log Setting"></a>
        </th>
    </tr>
    </thead>
</table>
...
<table id="member">
    <thead>
    <tr>
        <th>Newsbox Settings <a href="admin.php?p=editNewsboxSet"><img src="../img/admin/edit.gif"
                                                                       title="Edit Newsbox Setting"></a></th>
    </tr>
    </thead>
</table>
...
<table id="member">
    <thead>
    <tr>
        <th>Extra Settings <a href="admin.php?p=editExtraSet"><img src="../img/admin/edit.gif"
                                                                   title="Edit Extra Settings"></a></th>
    </tr>
    </thead>
</table>
...
<table id="member">
    <thead>
    <tr>
        <th>Admin Information <a href="admin.php?p=editAdminInfo"><img src="../img/admin/edit.gif"
                                                                       title="Edit Admin Info"></a></th>
    </tr>
    </thead>
</table>
<table id="profile">
