...
if (isset($dataarray[149]) and $dataarray[149] != 0) {
    $colspan2 = "11";
} else {
    $colspan2 = "10";
}
        ...
        <td colspan="2" class="report_content">
            <table cellpadding="1" cellspacing="1" id="attacker">
                ...
                <tr>
                    ...
                    <td colspan="<?php echo $colspan ?>"><?php echo $user_url; ?> from the
                        village <?php echo $from_url; ?></td>
                </tr>
                </thead>
                <tbody class="units">
                <tr>
                ...
                if ($dataarray[143] != '' and $dataarray[144] != '') { //chief
                    ...
                    <tr>
                        <th>Information</th>
                        <td colspan="<?php echo $colspan; ?>">
                            <img class="unit u<?php echo $dataarray[143]; ?>" src="img/x.gif" alt="Chief"
                                 title="Chief"/>
                ...
                <tr>
                    <th>Bounty</th>
                    <td colspan="<?php echo $colspan; ?>">
                        <div class="res"><img class="r1" src="img/x.gif" alt="Lumber"
                                              title="Lumber"/><?php echo $dataarray[23]; ?> | <img class="r2"
                                                                                                   src="img/x.gif"
                                                                                                   alt="Clay"
                                                                                                   title="Clay"/><?php echo $dataarray[24]; ?>
            ...
            if ($dataarray[34] == '1') {
                ...
                <table cellpadding="1" cellspacing="1" class="defender">
                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo $colspan2; ?>"><?php if ($targettribe == '1') {
                                echo $defuser_url . " from the village " . $deffrom_url;
                            } else {
                                echo "Reinforcement";
                            } ?></td>
                    </tr>
            ...
            if ($dataarray[55] == '1') {
                ...
                <table cellpadding="1" cellspacing="1" class="defender">
                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo $colspan2; ?>"><?php if ($targettribe == '2') {
                                echo $defuser_url . " from the village " . $deffrom_url;
                            } else {
                                echo "Reinforcement";
                            } ?></td>
            ...
            <?php if ($dataarray[76] == '1') {
                ...
                <table cellpadding="1" cellspacing="1" class="defender">
                    ...
                    <tr>
                        ...
                        <td colspan="<?php echo $colspan2; ?>"><?php if ($targettribe == '3') {
                                echo $defuser_url . " from the village " . $deffrom_url;
                            } else {
                                echo "Reinforcement";
                            } ?></td>
                    ...
                    <table cellpadding="1" cellspacing="1" class="defender">
                        ...
                        <tr>
                            ...
                            <td colspan="10"><?php if ($targettribe == '4') {
                                    echo '<a href="spieler.php?uid=">' . $database->getUserField($dataarray[28], "username", 0) . '</a> from the village <a href="karte.php?d=' . $dataarray[29] . '&amp;c=' . $generator->getMapCheck($dataarray[29]) . '">' . stripslashes($dataarray[30]) . '</a>';
                                } else {
                                    echo "Reinforcement";
                                } ?></td>
                        </tr>
                ...
                <?php if ($dataarray[128] == '1') {
                    ...
                    <table cellpadding="1" cellspacing="1" class="defender">
                        ...
                        <tr>
                            ...
                            <td colspan="<?php echo $colspan2; ?>"><?php if ($targettribe == '5') {
                                    echo $defuser_url . " from the village " . $deffrom_url;
                                } else {
                                    echo "Reinforcement";
                                } ?></td>
