...
<div class="wrapper">
    ...
    <div id="mid">
        ...
        <?php include("Templates/Plus/pmenu.php"); ?>
...
// Statement retrieve Gold Package A
                ...
                <table class="plusFunctions" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="desc"><b><font color="#71D000">
                                    <center>Package</center>
                                </font></b></td>
                        <td class="desc">
                            <center>60 Gold</center>
                        </td>
                        <td class="act">
                            <center>&nbsp;</center>
                        </td>
                ...
                <p>Please mail your username, package, order time and email used to <a href="mailto:cata7007@gmail.com">our
                        billing address</a>.</p>
...
// Statement retrieve Gold Package D
                ...
                <p>Please verify the information.<br/>It will let us know if the data is incorrect.</p>
                <p>Please mail your username, package, order time and email used to <a href="cata7007@gmail.com">our
                        billing address</a>.</p>
                <?
            ...
            if ($amount == 0) {
                ...
                <table class="plusFunctions" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="desc">
                            <center><b>Account inquiry</b></center>
                        </td>
                        <td class="desc">
                            <center><? echo $golds['6']; ?></center>
                        </td>
