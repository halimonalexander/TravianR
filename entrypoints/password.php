    ...
    <div id="mid">
        ...
        <div id="content" class="activate">
            ...
            if (isset($_POST['email']) && isset($_POST['npw'])) {
                ...
                ?>
                <p>Before you can request a new password you have to enter the email address that has been used to
                    register the account.
                    <br/><br/>Afterwards you will receive an e-mail with a new password. The password will only work
                    after confirming it, though.</p>
                <form action="password.php" method="POST">
                    ...
                    <p>
                        <input type="image" value="ok" name="s1" src="img/x.gif" class="dynamic_img" id="btn_ok"
                               alt="OK"/>
                    </p>
                </form>
                <?php
