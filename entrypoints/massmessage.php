...
if (mysql_num_rows(mysql_query("SELECT id FROM users WHERE access = 9 AND id = " . $session->uid)) != '1') die("Hacking attemp!");
        ...
        <div id="mid">
            ...
            <div id="content" class="login">
                <?php if (@!$NextStep && @!$NextStep2 && @!$done) { ?>
                    ...
                    <div name="smilll" id="message_smilies"
                         style="background:none repeat scroll 0 0 #EFEFEF;border:1px solid #71D000;left:20px;margin-top:5px;max-width:660px;padding:5px;position:relative;display: none;">
                        <?php echo MASS_READ; ?>
