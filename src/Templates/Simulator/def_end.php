        ...
        <table cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td class="value"><input class="text" type="text" name="ew2"
                                         ...
                                         maxlength="4" title="number Population"/></td>

                <td class="research"></td>
            </tr>
            <tr>
                <td class="ico"><img src="img/x.gif" class="unit upal" alt="Stonemason's Lodge"
                                     title="Stonemason's Lodge"/></td>
                <td class="desc" title="Stonemason's Lodge">Stonemason's Lodge</td>
                <td class="value"><input class="text" type="text" name="stonemason"
                                         value="<?php echo $form->getValue('stonemason') == "" ? 0 : $form->getValue('stonemason'); ?>"
                                         maxlength="2" title="Level Stonemason's Lodge"/></td>
                <td class="research"></td>
            </tr>
            <?php
            ...
            <tr>
                ...
                <td class="value"><input class="text" type="text" name="palast"
                                         ...
                                         maxlength="2" title="level Palace"/></td>
                <td class="research"></td>
            </tr>
            <tr>
                <td class="ico"><img src="img/x.gif" class="unit uhero" title="Hero" alt="Hero"/></td>
                <td class="desc">Hero (def bonus)</td>
                <td class="value"><input class="text" type="text" name="h_def_bonus"
                                         value="<?php echo $form->getValue('h_def_bonus') == "" ? 0 : $form->getValue('h_def_bonus'); ?>"
                                         maxlength="4" title="Hero (def bonus)"/></td>
                <td class="research"></td>
            </tr>
