...
if ($session->access != BANNED) {
    ...
    $public = mysql_query("SELECT * FROM forum_cat WHERE alliance = $ally AND forum_area = 1");
    $public1 = mysql_num_rows($public);
    $cofederation = mysql_query("SELECT * FROM forum_cat WHERE alliance = $ally AND forum_area = 2");
    $cofederation1 = mysql_num_rows($cofederation);
    $alliance = mysql_query("SELECT * FROM forum_cat WHERE alliance = $ally AND forum_area = 0");
    $alliance1 = mysql_num_rows($alliance);
    $closed = mysql_query("SELECT * FROM forum_cat WHERE alliance = $ally AND forum_area = 3");
