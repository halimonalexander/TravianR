        ...
        if ($lwref == $village->wid) {
            ...
            <form action="build.php?id=39&t=99&action=startRaid" method="post">
                ...
                <div class="listTitleText">
                    <a href="build.php?gid=16&t=99&action=deleteList&lid=<?php echo $lid; ?>"><img class="del"
                                                                                                   src="img/x.gif"
                                                                                                   alt="delete"
                                                                                                   title="delete"></a>
                        ...
                        <table class="list" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td class="village sortable"
                                    onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'village');">Village
                                </td>
                                <td class="ew sortable"
                                    onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'ew');">Pop
                                </td>
                                <td class="distance sortable"
                                    onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'distance');">Distance
                                </td>
                                <td class="troops sortable"
                                    onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'troops');">Troops
                                </td>
                                <td class="lastRaid sortable"
                                    onclick="Travian.Game.RaidList.sort(<?php echo $lid; ?>, 'lastRaid');">LastRaid
                                </td>
                                <td class="action"></td>
                            </tr>
                            </thead>
                ...
                <span class="coordinateX"><?php echo $y; ?>)</span>
                                        ...
                                        <td class="ew"><?php if ($oasistype == 0) {
                                                echo $vdata['pop'];
                                            } else {
                                                echo "<center>-</center>";
                                            }; ?></td>
                                        ...
                                        <td class="action">
                                            <a class="arrow"
                                               href="build.php?id=39&t=99&action=showSlot&eid=<?php echo $id; ?>">edit</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
                        ...
                        <div class="markAll">
                            <?php if ($checked[$lid] == 0) { ?>
                                <input type="checkbox" id="raidListMarkAll<?php echo $lid; ?>" class="markAll"
                                       onclick="window.location.href = '?gid=16&t=99&slid=<?php echo $lid; ?>';">
                            <?php } else { ?>
                                <input type="checkbox" id="raidListMarkAll<?php echo $lid; ?>" class="markAll"
                                       onclick="window.location.href = '?gid=16&t=99';" checked>
                            <?php } ?>
            ...
            <span class="troopSelectionValue">0</span>
                        ...
                        <button type="submit" value="Start Raid">
                            <div class="button-container">
                                ...
                                <div class="button-contents">Start Raid</div>
                            </div>
                        </button>
                    </div>
            </form>
