...
$top_rank = mysql_fetch_assoc(mysql_query("SELECT * FROM users WHERE access< 8 AND id > 5 AND tribe<=3 AND tribe > 0 ORDER BY oldrank ASC Limit 1"));
...
<div class="news">
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td>: <font color="Red"><?php if (MEDALINTERVAL >= 86400) {
