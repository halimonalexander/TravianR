<h1><img class="unit u30" src="img/x.gif" alt="Settler" title="Settler"/> Settler <span class="tribe">(Gauls)</span>
</h1>
...
<img id="big_unit" class="big_u30" src="img/x.gif" alt="Settler" title="Settler"/>
