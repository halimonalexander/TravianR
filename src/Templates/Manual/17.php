<h1><img class="unit u7" src="img/x.gif" alt="Battering Ram" title="Battering Ram"/> Battering Ram <span class="tribe">(Romans)</span>
</h1>
...
<img id="big_unit" class="big_u7" src="img/x.gif" alt="Battering Ram" title="Battering Ram"/>
