<h1><img class="unit u10" src="img/x.gif" alt="Settler" title="Settler"/> Settler <span class="tribe">(Romans)</span>
</h1>
...
<img id="big_unit" class="big_u10" src="img/x.gif" alt="Settler" title="Settler"/>
