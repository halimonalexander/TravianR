<h1><img class="unit ugeb" src="img/x.gif"> Cranny</h1><img class="building g23" src="img/x.gif" alt="Cranny"
...
<br/>
In T3.5 the cranny is 80% as effective against Teutons.<p><b>Costs</b> and <b>construction time</b> for level
    1:<br/><img class="r1" src="img/x.gif" alt="Lumber" title="Lumber"/>40 | <img class="r2" src="img/x.gif" alt="Clay"
                                                                                  title="Clay"/>50 | <img class="r3"
                                                                                                          src="img/x.gif"
                                                                                                          alt="Iron"
                                                                                                          title="Iron"/>30
    | <img class="r4" src="img/x.gif" alt="Crop" title="Crop"/>10 | <img class="r5" src="img/x.gif"
                                                                         alt="Crop consumption"
                                                                         title="Crop consumption"/>0 | <span
            class="dur"><img class="clock" alt="duration" title="duration" src="img/x.gif"/>0:12:30</span></p>
