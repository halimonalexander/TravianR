<h1><img class="unit u23" src="img/x.gif" alt="Pathfinder" title="Pathfinder"/> Pathfinder <span
...
<img id="big_unit" class="big_u23" src="img/x.gif" alt="Pathfinder" title="Pathfinder"/>
