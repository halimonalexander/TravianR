<h1><img class="unit u26" src="img/x.gif" alt="Haeduan" title="Haeduan"/> Haeduan <span class="tribe">(Gauls)</span>
</h1>
...
<img id="big_unit" class="big_u26" src="img/x.gif" alt="Haeduan" title="Haeduan"/>
