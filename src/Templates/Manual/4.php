...
<ul>
    ...
    <br/>
    <li><a href="http://www.travian.com/anleitung.php" target="_blank">Travian FAQ <img class="external" src="img/x.gif"
                                                                                        alt="new window"
                                                                                        title="new window"/></a><br>This
        ingame help just gives you brief information. More information is available at the <a
                href="http://help.travian.com/" target=blank>Travian FAQ</a>.
    </li>
    <br/>

    <li>
        <a href="http://help.travian.com/" target="_blank">Travian FAQ <img class="external" src="img/x.gif"
