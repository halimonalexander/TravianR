<h1><img class="unit u20" src="img/x.gif" alt="Settler" title="Settler"/> Settler <span class="tribe">(Teutons)</span>
</h1>
...
<img id="big_unit" class="big_u20" src="img/x.gif" alt="Settler" title="Settler"/>
