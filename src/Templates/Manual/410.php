<h1><img class="unit ugeb" src="img/x.gif"> Warehouse</h1><img class="building g10" src="img/x.gif" alt="Warehouse"
                                                               title="Warehouse"/>The resources lumber, clay and iron are stored in the warehouse. By increasing its level you increase your warehouse's capacity.
<p><b>Costs</b> and <b>construction time</b> for level 1:<br/><img class="r1" src="img/x.gif" alt="Lumber"
                                                                   title="Lumber"/>130 | <img class="r2" src="img/x.gif"
