<h1><img class="unit u3" src="img/x.gif" alt="Imperian" title="Imperian"/> Imperian <span class="tribe">(Romans)</span>
</h1>
...
<img id="big_unit" class="big_u3" src="img/x.gif" alt="Imperian" title="Imperian"/>
