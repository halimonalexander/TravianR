<h1><img class="unit u15" src="img/x.gif" alt="Paladin" title="Paladin"/> Paladin <span class="tribe">(Teutons)</span>
</h1>
...
<img id="big_unit" class="big_u15" src="img/x.gif" alt="Paladin" title="Paladin"/>
