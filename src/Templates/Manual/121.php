<h1><img class="unit u21" src="img/x.gif" alt="Phalanx" title="Phalanx"/> Phalanx <span class="tribe">(Gauls)</span>
</h1>
...
<img id="big_unit" class="big_u21" src="img/x.gif" alt="Phalanx" title="Phalanx"/>
