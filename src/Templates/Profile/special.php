<table cellpadding="1" cellspacing="1" id="support_mh">
    ...
    <tr>
        <td><b>Multihunter:</b><br>The Multihunters are responsible for the compliance with the <a href="#"
                                                                                                   target="_blank">game
                rules</a>. If you have questions about the rules or want to report a violation, you can message a
            Multihunter.<br/>
