...
<form action="spieler.php" method="POST">
    ...
    <table cellpadding="1" cellspacing="1" id="change_mail" class="account">
        ...
        <tbody>
        <tr>
            <td class="note" colspan="2">Please enter your old and your new e-mail addresses. You will then receive a
                code snippet at both e-mail addresses which you have to enter here.
            </td>
        </tr>
        <tr>
            <th>Old email</th>
    ...
    <table cellpadding="1" cellspacing="1" id="sitter" class="account">
        ...
        <tbody>
        <tr>
            <td class="note" colspan="2">A sitter can log into your account by using your name and his/her password. You
                can have up to two sitters.
            </td>
        </tr>
        <?php
        $count = 0;
        ...
        if ($count < 2) {
            ...
            <tr>
                ...
                <td><input class="text" type="text" name="v1" maxlength="15"><span class="count">(<?php echo $count; ?>/2)</span>
                </td>
            </tr>
            <?php
        }
        ...
        <tr>
            ...
            <?php if ($count == 0) {
                echo "<span class=\"none\">You have no sitters.</span></td>";
            }
            ...
            ?></tr>
        <tr>
            <td class="note" colspan="2">You have been entered as sitter on the following accounts. You can cancel this
    ...
    <table cellpadding="1" cellspacing="1" id="del_acc" class="account">
        ...
        <tbody>
        <tr>
            <td class="note" colspan="2">You can delete your account here. After starting the cancellation it will take
                three days to complete the cancellation of your account. You can cancel this process within the first 24
                hours.
            </td>
        </tr>
        <tr>
    ...
    ?>
    <p class="btn"><input type="image" value="" name="s1" id="btn_save" class="dynamic_img" src="img/x.gif" alt="save"/>
    </p>
</form>
