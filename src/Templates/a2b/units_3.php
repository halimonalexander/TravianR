    ...
    <table id="troops" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td class="line-first column-first large"><img class="unit u21" src="img/x.gif" title="Phalanx"
                                                           ...
                                                           alt="Phalanx"> <input
                        class="text" <?php if ($village->unitarray['u21'] <= 0) {
            ...
            <td class="line-first large"><img class="unit u24" src="img/x.gif" title="Theutates Thunder"
                        ...
                        class="text" <?php if ($village->unitarray['u24'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first regular"><img class="unit u27" src="img/x.gif" title="Ram" alt="Ram"> <input
                        class="text" <?php if ($village->unitarray['u27'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-first column-last small"><img class="unit u29" src="img/x.gif" title="Chieftain"
                                                          alt="Chieftain"> <input
                        class="text" <?php if ($village->unitarray['u29'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="column-first large"><img class="unit u22" src="img/x.gif" title="Swordsman" alt="Swordsman">
                <input class="text" <?php if ($village->unitarray['u22'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="large"><img class="unit u25" src="img/x.gif" title="Druidrider" alt="Druidrider"> <input
                        class="text" <?php if ($village->unitarray['u25'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="regular"><img class="unit u28" src="img/x.gif" title="Trebuchet" alt="Trebuchet"> <input
                        class="text" <?php if ($village->unitarray['u28'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="column-last small"><img class="unit u30" src="img/x.gif" title="Settler" alt="Settler"> <input
                        class="text" <?php if ($village->unitarray['u30'] <= 0) {
                    echo ' disabled="disabled"';
        ...
        <tr>
            <td class="line-last column-first large"><img class="unit u23" src="img/x.gif" title="Pathfinder"
                        ...
                        class="text" <?php if ($village->unitarray['u23'] <= 0) {
                    echo ' disabled="disabled"';
            ...
            <td class="line-last large"><img class="unit u26" src="img/x.gif" title="Haeduan" alt="Haeduan"> <input
                        class="text" <?php if ($village->unitarray['u26'] <= 0) {
                    echo ' disabled="disabled"';
