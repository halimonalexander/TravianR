...
<form method="post" action="a2b.php">
    ...
    <table id="short_info" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td>
                <a href="karte.php?d=<?php echo $process[0]; ?>&c=<?php echo $generator->getMapCheck($process[0]); ?>"><?php echo $process[1]; ?>
                    (<?php echo $coor['x']; ?>|<?php echo $coor['y']; ?>)</a></td>
        ...
        <tr>
            ...
            <td><a href="spieler.php?uid=<?php echo $process['2']; ?>"><?php echo $database->
                    getUserField($process['2'], 'username', 0); ?></a></td>
    ...
    <table class="troop_details" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            ";
                ...
                echo "10";
            } ?>"><?php echo $actionType . " to " . $process['1']; ?></td>
        ...
        <tr>
            ...
            <?php
            for ($i = $start; $i <= ($end); $i++) {
                echo "<td><img src=\"img/x.gif\" class=\"unit u$i\" title=\"" . $technology->getUnitName($i) . "\"
            alt=\"" . $technology->getUnitName($i) . "\" /></td>";
            }
            if ($process['t11'] != '') {
                echo "
        ...
        <?php if ($process['c'] == 1) {
            ...
            ";
                    ...
                    echo "10";
                } ?>"><input class="radio" name="spy" value="1" checked="checked" type="radio">Scout
                    resources and troops<br>
                    <input class="radio" name="spy" value="2" type="radio">Scout defences and
                    troops
                </td>
            </tr>
            </tbody>
        ...
        ";
            ...
            ";
                    ...
                    <div class="at">at <span id="tp2"> <?php echo $generator->
                            procMtime(date('U') + $time, 9) ?></span><span> hours</span></div>
    ...
    if ($database->hasBeginnerProtection($process['0']) == 1) {
        ...
        <p class="btn"><input value="ok" name="s1" id="btn_ok"
                              ...
                              class="dynamic_img " src="img/x.gif" alt="OK" type="image"
