...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <td class="desc">Initiate Payment by Paypal <br/>
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PS2CGCWUQHLU6"
               target="_blank">
            ...
            More Info about PayPal can be found here: <br/> <a href="#"
                                                               onclick="window.open('https://www.paypal.com/en/cgi-bin/webscr?cmd=xpt/cps/popup/OLCWhatIsPayPal-outside','external','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">More
                Info</a> <br/></td>
