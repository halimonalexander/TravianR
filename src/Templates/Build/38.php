...
<div id="build" class="gid38"><a href="#" onClick="return Popup(38,4);" class="build_logo">
    ...
    <h1><?php echo GREATWAREHOUSE; ?> <span
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid38[$village->resarray['f' . $id]]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
            </td>
        </tr>
        <tr>
            <?php
            if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
                ...
                if ($next <= 20) {
                    ...
                    <td><b><?php echo $bid38[$next]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
                    </td>
                    <?php
                } else {
                    ?>
                    <th><?php echo CAPACITY_LEVEL; ?> 20:</th>
                    <td><b><?php echo $bid38[20]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
                    </td>
                    <?php
                }
            }
