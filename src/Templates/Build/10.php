...
<div id="build" class="gid10"><a href="#" onClick="return Popup(10,4);" class="build_logo">
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid10[$village->resarray['f' . $id]]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
            </td>
        </tr>
        <tr>
            <?php
            if (!$building->isMax($village->resarray['f' . $id . 't'], $id)) {
                ...
                if ($next <= 20) {
                    ...
                    <td><b><?php echo $bid10[$next]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
                    </td>
                    <?php
                } else {
                    ?>
                    <th><?php echo CAPACITY_LEVEL; ?> 20:</th>
                    <td><b><?php echo $bid10[20]['attri'] * STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?>
                    </td>
                    <?php
                }
            }
