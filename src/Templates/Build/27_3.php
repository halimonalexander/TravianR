...
<div id="build" class="gid27">
    ...
    <table id="show_artefacts" cellpadding="1" cellspacing="1">
        ...
        if (mysql_num_rows(mysql_query("SELECT * FROM artefacts")) == 0) {
            ...
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 1");
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 1");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 2");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 2");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 3");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 3");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 4");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 4");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 5");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 5");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 6");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 6");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 2 AND type = 7");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 7");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
            ...
            unset($artefact);
            unset($row);
            $artefact = mysql_query("SELECT * FROM `artefacts` WHERE size = 3 AND type = 8");
            while ($row = mysql_fetch_array($artefact)) {
                echo '<tr>';
                echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
                echo '<td class="nam">';
