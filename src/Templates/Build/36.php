...
include("next.php");
?>
<div id="build" class="gid36"><h1><?php echo TRAPPER; ?> <span
    ...
    <table cellpadding="1" cellspacing="1" id="build_value">
        <tr>
            ...
            <td>
                <b><?php echo $bid36[$village->resarray['f' . $id]]['attri'] * TRAPPER_CAPACITY; ?></b> <?php echo TRAPS; ?>
            </td>
        </tr>
        <tr>
            <?php
    ...
    <p><?php echo CURRENT_HAVE; ?> <b><?php echo $village->unitarray['u99']; ?></b> <?php echo TRAPS; ?>,
        <b><?php echo $village->unitarray['u99o']; ?></b> <?php echo WHICH_OCCUPIED; ?></p>
                ...
                <tr>
                    <td class="desc">
                        <div class="tit"><img class="unit u99" src="img/x.gif"
                                              alt="Trap"
                                              title="Trap"/> <a href="#"
                                                                onClick="return Popup(36,4,'gid');"><?php echo TRAP; ?></a>
                            <span class="info">(<?php echo AVAILABLE; ?>: <?php echo $village->unitarray['u99']; ?>)</span>
                        </div>
                        <div class="details">
			<span><img class="r1" src="img/x.gif"
                       alt="Lumber" title="<?php echo LUMBER; ?>"/>20|</span><span><img class="r2" src="img/x.gif"
                                                                                        alt="Clay"
                                                                                        title="<?php echo CLAY; ?>"/>30|</span><span><img
                                        class="r3" src="img/x.gif"
                                        alt="Iron" title="<?php echo IRON; ?>"/>10|</span><span><img class="r4"
                                                                                                     src="img/x.gif"
                                                                                                     alt="Crop"
                                                                                                     title="<?php echo CROP; ?>"/>20|</span><span><img
                                        class="r5" src="img/x.gif" alt="Crop consumption"
                                        title="<?php echo CROP_COM; ?>"/>0|<img class="clock" src="img/x.gif"
                                                                                alt="Duration"
                                                                                title="<?php echo DURATION; ?>"/><?php $dur = $generator->getTimeFormat(round(${'u99'}['time'] * ($bid19[$village->resarray['f' . $id]]['attri'] * TRAPPER_CAPACITY / 100) / SPEED));
                    ...
                    <td class="max"><a href="#"
                                       onClick="document.snd.t99.value=<?php echo $max; ?>">(<?php echo $max; ?>)</a>
                    </td>
                </tr>
                </tbody>
            </table>
            <p><input type="image" id="btn_train" class="dynamic_img" value="ok" name="s1" src="img/x.gif" alt="train"
                      onclick="this.disabled=true;this.form.submit();"/></p></form>
        <?php
    } else {
