...
<div id="map_content">
    <div id="mbig">
        <div id="lightframe">
            <div id="darkframe"><a id="map_popclose" onClick="Close();"><img src="img/x.gif" alt="close Map"
                                                                             title="close Map"></a>
                ...
                <div id="map">
                    ...
                    <map id="map_overlay_large" name="map_overlay_large">
                        <?php echo $map_gen; ?>
                        <area id="ma_n1" href="karte2.php?z=<?php echo $generator->getBaseID($x, $yp1); ?>"
                              coords="762,115,30" shape="circle" title="North"/>
                        <area id="ma_n2" href="karte2.php?z=<?php echo $generator->getBaseID($xp1, $y); ?>"
                              coords="770,430,30" shape="circle" title="East"/>
                        <area id="ma_n3" href="karte2.php?z=<?php echo $generator->getBaseID($x, $ym1); ?>"
                              coords="210,430,30" shape="circle" title="South"/>
                        <area id="ma_n4" href="karte2.php?z=<?php echo $generator->getBaseID($xm1, $y); ?>"
                              coords="200,115,30" shape="circle" title="West"/>
                    </map>
                    ...
                    <map name="map_navibox">
                        <area id="ma_n1p7" href="karte.php?z=<?php echo $generator->getBaseID($x, $yp7) ?>"
                              coords="51,15,73,3,95,15,73,27" shape="poly" title="North"/>
                        <area id="ma_n2p7" href="karte.php?z=<?php echo $generator->getBaseID($xm7, $y) ?>"
                              coords="51,41,73,29,95,41,73,53" shape="poly" title="East"/>
                        <area id="ma_n3p7" href="karte.php?z=<?php echo $generator->getBaseID($x, $ym7) ?>"
                              coords="4,41,26,29,48,41,26,53" shape="poly" title="South"/>
                        <area id="ma_n4p7" href="karte.php?z=<?php echo $generator->getBaseID($xp7, $y) ?>"
                              coords="4,15,26,3,48,15,26,27" shape="poly" title="West"/>
                    </map>
                    <div id="map_coords">
                        <form name="map_coords" method="post">
                            <span>x </span><input id="mcx" class="text" name="xp" value="<?php echo $x ?>"
                                                  maxlength="4"/>
                            <span>y </span><input id="mcy" class="text" name="yp" value="<?php echo $y ?>"
                                                  maxlength="4"/>
                            <input type="image" id="btn_ok" class="dynamic_img" value="ok" name="s1" src="img/x.gif"
                                   alt="OK"/>
                        </form>
                    </div>
                    <table cellpadding="1" cellspacing="1" id="map_infobox" class="default">
                        <thead>
                        <tr>
                            <th colspan="2"><?php echo DETAIL; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
