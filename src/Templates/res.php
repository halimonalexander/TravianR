    ...
    <div id="resWrap">
        ...
        <table cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td id="l4"
                    title="<?php echo $wood; ?>"><?php echo round($village->awood) . "res.php/" . $village->maxstore; ?></td>
                <td><img src="img/x.gif" class="r2" alt="<?php echo CLAY; ?>" title="<?php echo CLAY; ?>"/></td>
                <td id="l3"
                    title="<?php echo $clay; ?>"><?php echo round($village->aclay) . "res.php/" . $village->maxstore; ?></td>
                <td><img src="img/x.gif" class="r3" alt="<?php echo IRON; ?>" title="<?php echo IRON; ?>"/></td>
                <td id="l2"
                    title="<?php echo $iron; ?>"><?php echo round($village->airon) . "res.php/" . $village->maxstore; ?></td>
                <td><img src="img/x.gif" class="r4" alt="<?php echo CROP; ?>" title="<?php echo CROP; ?>"/></td>
                <?php if ($village->acrop > 0) { ?>
                    <td id="l1"
                        title="<?php echo $crop; ?>"><?php echo round($village->acrop) . "res.php/" . $village->maxcrop; ?></td>
                <?php } else { ?>
