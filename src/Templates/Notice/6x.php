            ...
            <table cellpadding="1" cellspacing="1" id="attacker">
                ...
                <tr>
                    ...
                    <td colspan="<?php echo $colspan; ?>"><a
                                href="spieler.php?uid=<?php echo $database->getUserField($dataarray[0], "id", 0); ?>"><?php echo $database->getUserField($dataarray[0], "username", 0); ?></a>
                        from the village <a
                ...
                <table cellpadding="1" cellspacing="1" class="defender">
                    ...
                    <tr>
                        ...
                        if ($targettribe == '4' and isset($dataarray[149]) and $dataarray[149] != 0) {
                            ?>
                            <td colspan="<?php echo $colspan2; ?>"><?php if ($targettribe == '4') {
                                    echo '<a href="spieler.php?uid=' . $database->getUserField($dataarray[28], "id", 0) . '">' . $database->getUserField($dataarray[28], "username", 0) . '</a> from the village <a href="karte.php?d=' . $dataarray[29] . '&amp;c=' . $generator->getMapCheck($dataarray[29]) . '">' . stripslashes($dataarray[30]) . '</a>';
                                } else {
                                    echo "Reinforcement";
                                } ?></td>
