...
session_start();
include("../Database/GrandRepository.php");
...
<script language="javascript">
    ...
    function del(e, id) {
        if (e == 'did') {
            var conf = confirm('Dou you really want delete village id ' + id + '?');
        }
        if (e == 'unban') {
            var conf = confirm('Dou you really want unban player ' + id + '?');
        }
        if (e == 'stopDel') {
            var conf = confirm('Dou you really want stop deleting user ' + id + '?');
        }
        if (conf) {
            return true;
        } else {
...
<div id="ltop1">
    ...
    <img class="fl2" src="../img/admin/x1.gif" width="70" height="100" border="0" onmouseover="this.className='fl1'"
         onmouseout="this.className='fl2'"><img class="fl2" src="../img/admin/x2.gif" width="70" height="100" border="0"
...
<div id="lmidall">
    <div id="lmidlc">
        <div id="lleft">
            <a href="index.php"><img src="../img/en/a/travian0.gif" class="logo_plus" width="116" height="60"
                                     border="0"></a>
            ...
            <table id="navi_table" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="menu">
                        ...
                        if ($funct->CheckLogin()) {
                            ?>
                            <a href="admin.php">ACP Home</a>      <a href="<?php echo HOMEPAGE; ?>">Homepage</a>      <a
                                    href="#"></a><a href="#"></a>      <a href="?p=server_info">Server Info</a>
                            <a href="?p=online">Online users</a>
                            <a href="?p=search">Search</a>
                            <a href="?p=message">Msg/Rep</a>
                            <a href="?p=ban">Ban</a>
                            <a href="?p=config">Config</a>
                            <a href="?p=config_editor">Config Editor</a>      <a href="#"></a><a href="#"></a><a
                                    href="#"></a>
                ...
                if ($funct->CheckLogin()) {
                    if ($_POST or $_GET) {
                        if ($_GET['p'] and $_GET['p'] != "search") {
                            $filename = '../Templates/Admin/' . $_GET['p'] . '.php';
                            if (file_exists($filename)) {
                                include($filename);
                            } else {
                                include('../Templates/Admin/404.php');
                            }
                        } else {
                            include('../Templates/Admin/search.php');
                        }
                        if ($_POST['p'] and $_POST['s']) {
                            $filename = '../Templates/Admin/results_' . $_POST['p'] . '.pgp';
                            if (file_exists($filename)) {
                                include($filename);
                            } else {
                                include('../Templates/Admin/404.php');
                        ...
                        include('../Templates/Admin/home.php');
                    }
                } else {
