...
for ($i = 1; $i <= $amt; $i++) {
    ...
    $time = time();
    $q = "insert  into vdata (`wref`,`owner`,`name`,`capital`,`pop`,`cp`,`celebration`,`type`,`wood`,`clay`,`iron`,`maxstore`,`crop`,`maxcrop`,`lastupdate`,`loyalty`,`exp1`,`exp2`,`exp3`,`created`) values ('$wid','3','" . PLANVILLAGE . "',0,0,0,0,0,80000.00,80000.00,80000.00,80000,80000.00,80000,1314974534,100,0,0,0,1314968914)";
    mysql_query($q));
    ...
    $speed = NATARS_UNITS;
    $q = "UPDATE units SET u41 = u41 + " . (1500 * $speed) . ", u42 = u42 + " . (1500 * $speed) . ", u43 = u43 + " . (1500 * $speed) . ", u44 = u44 + " . (1500 * $speed) . ", u45 = u45 + " . (1500 * $speed) . ", u46 = u46 + " . (1500 * $speed) . ", u47 = u47 + " . (1500 * $speed) . ", u48 = u48 + " . (1500 * $speed) . " , u49 = u49 + " . (1500 * $speed) . ", u50 = u50 + " . (1500 * $speed) . " WHERE vref = '" . $wid . "'";
    mysql_query($q);
    $desc = PLAN_DESC;
...
mysql_query("Insert into admin_log values (0,$id,'Added <b>$amt</b> WW Buildingplan Villages'," . time() . ")");
